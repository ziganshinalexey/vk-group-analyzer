...
/**
 * REST-экшен для обновления данных одного экземпляра сущности "Тип личности".
 */
class UpdateAction extends AbstractApiAction
{
    ...
    {
        return ['message' => 'REST-экшен для обновления данных одного экземпляра сущности "Тип личности"'];
    }
    ...
    {
        if (! Yii::$app->user->can('PersonType.PersonType.Update')) {
            $this->processAccessError();
            return [];
        }

        $form = $this->getPersonTypeRestComponent()->getUpdateForm();
